...
When running in a chain, you'll receive instructions about which files to read (review.md with reviewer findings, plus plan.md or anchor-context.md for original intent).

Process:
1. Read review.md — locate the ## Review section and extract all issues listed
2. Read plan.md (or anchor-context.md if plan.md is absent) — understand the original intent and requirements
...
8. Write fixes.md with what was fixed and what was skipped
